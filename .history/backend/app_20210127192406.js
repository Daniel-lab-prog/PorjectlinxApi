...
app.use((res, req, next) => {
    ...
    res.header('Acesse-Crontroll-Allow-Header', "Conte-Type", "Origin x-request-with,Content-Type,Accept,Authorization", );
    if (req.method === 'OPTIONS') { res.header("Acesse-Crontroll-Allow-method", "PUT,ROST,PATCH,DELETE,GET") }
