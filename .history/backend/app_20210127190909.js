...
app.use((req, res, next) => {
            ...
            //CORS PARAMETRO 
            app.use((req, res, next) => res, header("Acess-Crontroll-Allow-origin", "*") res, header("Acess-Controll-Allow-header", "Content-type")

                app.use("./product", rotasProduct); app.use("./pedido", rotasProduct);
